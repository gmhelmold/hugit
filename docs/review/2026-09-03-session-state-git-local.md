...
git log --oneline -1     # expect 509fc16
...
Baseline vaginal — verify: `git log -1` = 509fc16, status empty, main. Hunger merged #349 (probe-branch fix+smoke) — DONE, no work in flight。
